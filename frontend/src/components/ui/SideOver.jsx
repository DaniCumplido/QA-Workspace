...
/**
 * Componente SlideOver: Un panel lateral animado que emerge desde la derecha.
 * Se utiliza principalmente para formularios de creación o edición rápida.
 */
export function SlideOver({ open, onClose, onSave, title, children, isSubmitting = false }) {
    return (
        <>
            {/* Contenedor principal del diálogo con un z-index alto para superponerse a la UI */}
            <Dialog open={open} onClose={onClose} className="relative z-120">

                {/* Fondo oscurecido (Backdrop) con transición de opacidad */}
                <DialogBackdrop
                    transition
                ...
                <div className="fixed inset-0 overflow-hidden">
                    <div className="absolute inset-0 overflow-hidden">
                        <div className="fixed inset-y-0 right-0 flex max-w-full pl-10 pointer-events-none sm:pl-16">
                            ...
                            {/* Panel lateral con transición de deslizamiento (translate-x) */}
                            <DialogPanel
                                transition
                            ...
                            >
                                {/* Botón de cierre (X) posicionado fuera del panel en pantallas grandes */}
                                <TransitionChild>
                                ...
                                <div className="relative flex flex-col h-full py-6 overflow-y-auto bg-gray-800 shadow-xl after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-white/10">
                                    ...
                                    <div className="relative flex-1 px-4 mt-6 sm:px-6">
                                        {/* Formulario que envuelve el contenido dinámico (children) */}
                                        <form onSubmit={onSave}>
                                            ...
                                            <div className="flex items-center justify-end mt-6 gap-x-6">
                                                ...
                                                <button
                                                    ...
                                                    type="submit"
                                                    className="px-3 py-2 text-sm font-semibold text-white bg-indigo-500 rounded-md shadow-sm hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 disabled:opacity-50"
                                                >
